   ...
   return (
    <div style={styles.container}>
      ...
      <main style={styles.mainContent}>
        ...
        <h1 style={styles.title}>Your registration is waiting approval</h1>
        <p style={styles.subtitle}>
          Your registration (ID: XXXXXXXXX) is in progress.<br />
          It takes 2-3 days for verification. You'll get an SMS when it's done.
        </p>
        
        <button style={styles.primaryButton}>View My Application</button>
      </div>
